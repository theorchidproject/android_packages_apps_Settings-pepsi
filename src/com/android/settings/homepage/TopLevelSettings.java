...
public class TopLevelSettings extends DashboardFragment implements
    ...
    protected int getPreferenceScreenResId() {
        return R.xml.OrchidOs_top_level_settings;
    }
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        for (int i = 0; i < screen.getPreferenceCount(); i++) {
            ...
            if (isValid && pref.getLayoutResource() != R.layout.OrchidOs_dashboard_preference_top &&
                pref.getLayoutResource() != R.layout.OrchidOs_dashboard_preference_bottom) {
                pref.setLayoutResource(R.layout.OrchidOs_dashboard_preference_middle);
            }
        }
        if (screen == null) {
            return;
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.OrchidOs_top_level_settings) {
