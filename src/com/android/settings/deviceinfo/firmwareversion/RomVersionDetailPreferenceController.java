...
public class RomVersionDetailPreferenceController extends BasePreferenceController {
    ...
    private static final Uri INTENT_URI_DATA = Uri.parse("https://github.com/EpicROM-AOSP");
    private static final String TAG = "romDialogCtrl";
    private static final String KEY_ROM_VERSION_PROP = "ro.epic.build.version";
    private static final String KEY_ROM_RELEASETYPE_PROP = "ro.epic.build.type";
    private static final String KEY_ROM_VARIANT_PROP = "ro.epic.build.variant";
